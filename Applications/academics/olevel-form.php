...
<input type="hidden" id="olevelComplete" name="olevelComplete" value="false">
        ...
        <div class="mt-3">
            <table class="table">
                ...
                <tfoot>
                    ...
                    <input type="hidden" id="distinctionsInput" name="distinctions" value="0">
                    <input type="hidden" id="creditsInput" name="credits" value="0">
                    <input type="hidden" id="passesInput" name="passes" value="0">
                    <input type="hidden" id="failuresInput" name="failures" value="0">
                    <tr>
